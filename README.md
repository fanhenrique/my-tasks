...
This project is basead on <p><link href="https://github.com/klaudiosinani/taskbook.git">Taskbook</p>. Using the Taskbook the need arose to create sub-tasks, so I remodeled the project to use a tree structure, thus allowing to group tasks.
